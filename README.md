...
* The COGsoft suite of programs, which have to be compiled locally to work. These are availalbe at: [link] (ftp://ftp.ncbi.nih.gov/pub/wolf/COGs/COGsoft "COGsoft.201204.tar").  Executables are accessed via the folder, not necessarilly from the path.
