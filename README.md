...
* The COGsoft suite of programs, which have to be compiled locally to work. These are available at: [COGsoft.201204.tar] (ftp://ftp.ncbi.nih.gov/pub/wolf/COGs/COGsoft).  Executables are accessed via the folder, not necessarilly from the path.
